                ...
                <div class="add-task-form-row">
                    ...
                    <div class="add-task-title">
                        ...
                        <div class="assigned-input">
                            <input onclick="openUserList('user-select', 'selected-user')" class="input-task-select" type="text"
                                placeholder="Select contacts to assign">
                            <img onclick="openUserList('user-select', 'selected-user')" id="input-icon" class="input-arrow"
