...
function renderContactDetails(contact) {
    ...
    <div id="showContactHeaderBox" class="showContactHeaderBox">
                <div class="showContactHeadline z_index2">
                    ...
                    <p style="color:black; font-size: 20px; margin: 5px;">Better with a team!</p>
                    <div id="blue_line_horizontal_show_contacts_container_desktop" class="blue_line_horizontal"></div>
                </div>

                <div class="close_icon_box">
                    <img style="cursor: pointer; height: 36px;" onclick="closeShowContact()"
                        src="./assets/img/arrow_left.svg" alt="close Button">
                </div>
            </div>
            ...
            <div id="showContactFooterBox"">
                        ...
                        <div id="edit_delete_desktop_icons" style="display: flex;">
                            <div class="fill_icon" onclick="openEditContactCard()" class="edit_delete_buttons">
                                <svg width="96" height="40" viewBox="0 0 96 40" fill="none"
                                    ...
                                    <mask id="mask0_71395_18214" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                            ...
                            <div class="fill_icon" onclick="closeShowContact()" class="edit_delete_buttons">
                                <svg width="96" height="40" viewBox="0 0 96 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <mask id="mask0_71395_18225" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                        x="7" y="8" width="25" height="24">
                ...
                <div id="contact_card_email" class="contacts_e-mail">
                ${e_mail}
                </div>
